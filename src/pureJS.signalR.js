;(function (window) {
    ...
    var jQueryShim = function () {
        ...
        */
        ...
        function isFunction(obj) { return getType(obj) === "function"; }
        ...
        */
        ...
        jqueryFunction.type = getType;
        jqueryFunction.isArray = isArray;
        jqueryFunction.isFunction = isFunction;
        jqueryFunction.each = each;
        jqueryFunction.extend = extend;
        jqueryFunction.noop = function () { };
        jqueryFunction.Deferred = Deferred;
        jqueryFunction.ajax = ajax;
        jqueryFunction.inArray = (arr, item) => arr.indexOf(item) !== -1;
        jqueryFunction.trim = str => str && str.trim();
        jqueryFunction.isEmptyObject = obj => !obj || Object.keys(obj).length === 0;
        jqueryFunction.makeArray = arr => [].slice.call(arr, 0);
        jqueryFunction.param = obj => param(obj);
        jqueryFunction.support = {
            cors: (function () {
                let xhrObj = xhr();
    ...
    /*!
    * ASP.NET SignalR JavaScript Library v2.4.1
    * http://signalr.net/
    *
    ...
    */
    ...
    window.hubConnection = jQueryShim.hubConnection;
    window.signalR = jQueryShim.signalR;
